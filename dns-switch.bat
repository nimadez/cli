...
echo =====================================================
echo  0. Fastest[IR] ... 1.0.0.1 / 8.8.4.4
...
echo =====================================================
echo  6. Shecan ........ 178.22.122.100 / 185.51.200.2
echo  7. Begzar ........ 185.55.226.26 / 185.55.225.25
echo  8. Arvan Cloud ... 185.231.182.126 / 37.152.182.112
echo  9. Mobinnet ...... 10.104.88.8 / 10.104.88.9
echo =====================================================
echo  B. Run Benchmark
echo =====================================================
set /p opt="> "
setlocal EnableDelayedExpansion
if "%opt%"=="0" set DNSA=1.0.0.1 && set DNSB=8.8.4.4 && goto SETDNS
