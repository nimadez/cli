...
# - Adwaita theme reference: ~/.local/share/gnome-shell/themes/default-ref
#
...
mkdir -p ~/.local/share/gnome-shell/themes/default-ref
...
# copy the default Adwaita theme as a reference
for file in `gresource list /usr/share/gnome-shell/gnome-shell-theme.gresource`; do
    gresource extract /usr/share/gnome-shell/gnome-shell-theme.gresource $file > ~/.local/share/gnome-shell/themes/default-ref/$(basename -- "$file");
done
