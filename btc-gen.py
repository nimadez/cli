#!/usr/bin/env python3
#
# Generate bitcoin keys and base64
...
if __name__ == "__main__":
    ...
    timestamp = datetime.datetime.now().strftime("%b-%d-%G|%H:%M:%S").upper()
    private = getWif(randomBytes)
    public = getPublicKey(randomBytes)
    data = "CREATED|%s\nPRIVATE|%s\nADDRESS|%s"%(timestamp, private, public)
